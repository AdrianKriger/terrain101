...
**some notes:**
 ...
 - If `shapes` in the [params](https://github.com/AdrianKriger/terrain101/blob/main/hw04_a/params.json) is set to `True`; a &alpha;-shape of the planes with be written to a `.shp`. It's not very orthogonal.
